...
const UpdateCoursPayant = ({ handleUpdateCoursClose, categories, coursId }) => {
  ...
  const get_Couse_Payant = async (id) => {
    try {
      const res = await axios.get(
        // `http://localhost:5000/api/get-one-cours-Payant/${id}`,
        `https://ma-training-consulting-company-site-backend.vercel.app/api/get-one-cours-Payant/${id}`,
      )
  ...
  useEffect(() => {
    get_Couse_Payant(coursId)
  }, [])

  const handleUpdateFreeCoursData = async (e) => {
    e.preventDefault()
    // if (!validate()) return
    ...
    try {
      ...
      const dataToSubmit = {
        ...freeCoursData,
        cour_image: !fileURL ? freeCoursData.cour_image : cour_image_url,
              ...
              <div className="header">
                <div className="row mt-4 tm-edit-product-row w-100">
                  <div className="col-xl-7 col-lg-7 col-md-12">
                    <form onSubmit={handleUpdateFreeCoursData} className="tm-edit-product-form">
                      <div>
                  ...
                  <div className="col-xl-4 col-lg-4 col-md-12 mx-auto mb-4 text-center">
                    <div>
                      <div className="tm-product-img-dummy mx-auto">
                        {fileURL || freeCoursData.cour_image ? (
                          <img
                            style={{
                              width: '100%',
                              maxHeight: '100%',
                            ...
                            id="bg-video"
                            src={fileURL ? fileURL : freeCoursData.cour_image}
                            alt="image"
                          />
                        ) : (
                          <i
...
export default UpdateCoursPayant
