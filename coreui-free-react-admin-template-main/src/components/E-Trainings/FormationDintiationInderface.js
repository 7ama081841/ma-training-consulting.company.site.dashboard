...
const FormationDintiationInderface = ({ get_Formation_Dintiation_Inderface }) => {
                  ...
                  <div className="col-xl-4 col-lg-4 col-md-12 mx-auto mb-4 text-center ">
                    <div className="tm-product-img-dummy mx-auto">
                      {fileURL ? (
                        ...
                        >
                          inderface 1<i className="fas fa-5x fa-cloud-upload-alt"></i>
                        </span>
                      )}
                    </div>
                    ...
                    <div className="tm-product-img-dummy mx-auto">
                      {fileURL2 ? (
                        ...
                        >
                          interface 2<i className="fas fa-5x fa-cloud-upload-alt"></i>
                        </span>
                      )}
                    </div>
                    <div className="custom-file mt-3 mb-3">
...
export default FormationDintiationInderface
