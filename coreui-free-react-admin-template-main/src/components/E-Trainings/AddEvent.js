...
const AddEvent = ({ handleAddEventClose, getAllEvents }) => {
  ...
  const handleSubmitDefinitionData = async (e) => {
    ...
    try {
      ...
      const event_image_url = definitionData.event_image
        ? await uploadFile(
            definitionData.event_image,
            `event/images/${definitionData.event_image.name}`,
          )
        : null
      ...
      const res = await axios.post(
        // 'http://localhost:5000/api/add-Event-Data',
        'https://ma-training-consulting-company-site-backend.vercel.app/api/add-Event-Data',
        dataToSubmit,
        {
          headers: {
