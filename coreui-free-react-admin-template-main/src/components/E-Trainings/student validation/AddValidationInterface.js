...
const AddValidationInterface = ({ get_Validation_Interface }) => {
  ...
  const handleSubmitDefinitionData = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        // 'http://localhost:5000/api/add-Validation-Interface',
        'https://ma-training-consulting-company-site-backend.vercel.app/api/add-Validation-Interface',
        dataToSubmit,
        {
          headers: {
...
export default AddValidationInterface
